...
public class InfoRom{
    ...
    public String cartridgeTypeString(){
        ...
        switch(type){
            ...
            case 0x08: return "ROM + RAM"; break;
            case 0x09: return "ROM + RAM + BATTERY"; break;
            case 0x0b: return "MMM01"; break;
            case 0x0c: return "MMM01 + RAM"; break;
            case 0x0d: return "MMM01 + RAM + BATTERY"; break;
            case 0x0F: return "MBC03 + TIMER + BATTERY"; break;
            case 0x10: return "MBC03 + TIMER + RAM + BATTERY"; break;
            case 0x11: return "MBC03"; break;
            case 0x12: return "MBC03 + RAM"; break;
            default: return "UNKNOWN"; break;
        }
    }
    public int cartridgeRomSize(){
        //retourne la taille de la rom en fonction d'une indication
        int size = _memory.getByte(0x0148);
        switch(size){
        case 0x00: return "32KBytes (no bank)"; break;
        case 0x01: return "64KBytes (4 banks)"; break;
        case 0x02: return "128KBytes (8 banks)"; break;
        case 0x03: return "256KBytes (16 banks)"; break;
        case 0x04: return "512KBytes (32 banks)"; break;
        case 0x05: return "1MBytes (64 banks)"; break;
        case 0x06: return "2MBytes (128 banks)"; break;
        case 0x07: return "4MBytes (256 banks)"; break;
        case 0x52: return "1.1MBytes (72 banks)"; break;
        case 0x53: return "1.2MBytes (80 banks)"; break;
        case 0x54: return "1.5MBytes (96 banks)"; break;
        default: return "UNKNOWN"; break;
        }
    }
    public String cartridgeRamSize(){
        ...
        switch (ramSize){
            case 0x00: return "None or 512x2"; break;
            case 0x01: return "2 KBytes"; break;
            case 0x02: return "8 KBytes"; break;
            case 0x03: return "32 KBytes (4 banks of 8KBytes each)"; break;
        }
    }
